...
import com.lss.core.validate.code.image.ImageCode;
...
public class ValidateFilter extends OncePerRequestFilter{
    ...
    private void validate(ServletWebRequest request) throws ServletRequestBindingException {
        ...
        ImageCode codeInSession = (ImageCode) sessionStrategy.getAttribute(request,ValidateCodeProcessor.SEESSION_KEY+"IMAGE");
        ...
        if(codeInSession.isExpired()){
            sessionStrategy.removeAttribute(request,ValidateCodeProcessor.SEESSION_KEY+"IMAGE");
